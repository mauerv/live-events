  ...
  render() {
    ...
    return (
      <RegisterContainer>
        ...
        <RegisterDescription>
          An experiment in digital events. Please input a nickname to use at the
          rooms.
        </RegisterDescription>
        <SimpleForm
        ...
        />
        {user.registered === "registering" ? (
          <RegisterPrompt>Please wait while we set up...</RegisterPrompt>
        ) : null}
      </RegisterContainer>
    );
  }
